...
[v1.2.1 Export CSV Report](https://github.com/JustinHammitt/SupaBoxPacker/releases/tag/v1.2.1) Stay tuned for patch b the report export is not very user friendly
